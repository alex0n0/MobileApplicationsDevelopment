    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // start AsyncTask
                SearchActivity.GoogleSearchAsyncTask1 searchTask = new SearchActivity.GoogleSearchAsyncTask1();
                searchTask.execute(url);
            }
        });
    }

    private class GoogleSearchAsyncTask1 extends AsyncTask<URL, Integer, String> {
