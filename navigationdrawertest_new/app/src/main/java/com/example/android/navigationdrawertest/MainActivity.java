    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.fragment_frame) != null) {
            ...
            getSupportFragmentManager()
                    .beginTransaction()
                    .add(R.id.fragment_frame, homeScreenFragment)
                    .commit();
        }
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.Home_button:
                                ...
                                transaction.replace(R.id.fragment_frame, homeScreenFragment);
                                transaction.addToBackStack(null);

                                transaction.commit();
                                break;
                            case R.id.Topics_button:
                                topics topicslayoutFragment = new topics();

                                topicslayoutFragment.setArguments(args);

                                transaction.replace(R.id.fragment_frame, topicslayoutFragment);
                                transaction.addToBackStack(null);
                            ...
                            case R.id.Videos_button:
                                ...
                                transaction.replace(R.id.fragment_frame, videosFragment);
                                transaction.addToBackStack(null);
                            ...
                            case R.id.Quiz_button:
                                ...
                                transaction.replace(R.id.fragment_frame, quizFragment);
                                transaction.addToBackStack(null);
